...
public class ApplicationUseCase {
    ...
    public Mono<String> create(String identityDocument, BigDecimal amount, Integer termMonths, Integer loanTypeId) {
        return userService.getUserByDocument(identityDocument)
